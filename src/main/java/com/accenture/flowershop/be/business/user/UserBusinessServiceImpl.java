...
import com.accenture.flowershop.be.business.marshalling.UserMarshgallingService;
...
public class UserBusinessServiceImpl implements UserBusinessService {
    ...
    @Override
    @Transactional
    public boolean register(String firstName, String lastName, String address, BigDecimal money, String tel, Integer discount, String username, String password, String email) {

        UserRole userRole = this.customerAccessService.getUserRole(2);
        User user = new User(firstName, lastName, address, money, tel, discount, username, password, email, userRole);
